...
```
cd existing_repo
git remote add origin https://gitlab.com/ivan_startup/buildings-communication.git
git branch -M main
...
-   [ ] [Set up project integrations](https://gitlab.com/ivan_startup/buildings-communication/-/settings/integrations)
